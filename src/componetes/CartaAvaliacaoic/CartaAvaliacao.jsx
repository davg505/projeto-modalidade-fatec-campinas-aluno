...
import { criarCartaAvalIc,  buscarDadosic, buscarDadosAluno } from '../../services/apiService';
...
const CartaAvaliacao = ({ show, handleClose, handleSubmit }) => {
  ...
  const gerarEPDFEnviar = async () => {
   ...
   if (!dadosIc || !dadosAlunos) {
    ...
    formData.append("arquivo", pdfBlob, `CartaAvaliacao-${ra}.pdf`);
    ...
    try {
      ...
      a.href = url;
      a.download = `CartaAvaliacao-${ra}.pdf`;
      a.click();
  ...
  return (
    <div className={style.modalBackground}>
      <div className={style.modalContainer}>
        <h3>Carta Avaliação I. Científica</h3>
